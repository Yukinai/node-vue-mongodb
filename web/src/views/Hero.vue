<template>
  <div class="page-hero fs-md" v-if="model">
    <div class="topbar bg-black py-0 px-2 d-flex ai-center text-white">
      <img src="../assets/logo.jpg" height="30" />
      <div class="px-2 flex-1">
        <span class="text-white fs-xl">王者荣耀</span>
        <span class="ml-3 px-2">攻略站</span>
      </div>
    ...
    <div>
      ...
      <swiper>
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bootom">
              <div class="d-flex">
                <router-link tag="bottom" to="/" class="btn btn-lg flex-1">
                  <i class="iconfont icon-cc-menu-circle"></i>
                  英雄介绍视频
                </router-link>
                <router-link tag="bottom" to="/" class="btn btn-lg flex-1 ml-2">
                  <i class="iconfont icon-cc-menu-circle"></i>
                  英雄介绍视频
                </router-link>
              </div>
            ...
            <m-card plain icon="cc-menu-circle" title="英雄关系">
              ...
              <div v-for="item in model.partner" :key="item.name" class="d-flex pt-3">
...
.page-hero {
  ...
  .skills {
    icon {
      ...
      border-radius: 50%;
      &.active {
        border-color: map-get($colors, "priary");
      }
    }
  }
  .hero-items {
