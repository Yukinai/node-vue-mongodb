      ...
      <el-tabs value="skills" type="border-card">
        <el-tab-pane label="基础信息" name="basic">
          ...
          <el-form-item label="使用技巧">
            <el-input type="textares" v-model="model.usageTips"></el-input>
          </el-form-item>
          <el-form-item label="对抗技巧">
            <el-input type="textares" v-model="model.battleTips"></el-input>
          </el-form-item>
          <el-form-item label="团战思路">
            <el-input type="textares" v-model="model.teamTips"></el-input>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="技能" name="skills">
          <el-button sizes="small" @click="model.skills.push({})">
